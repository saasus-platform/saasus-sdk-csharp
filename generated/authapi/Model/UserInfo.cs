...
namespace authapi.Model
{
    ...
    public partial class UserInfo : IEquatable<UserInfo>, IValidatableObject
    {
        ...
        /// <param name="tenants">テナント情報(Tenant Info) (required).</param>
        public UserInfo(string id = default(string), string email = default(string), List<UserAvailableTenant> tenants = default(List<UserAvailableTenant>))
        {
        ...
        /// テナント情報(Tenant Info)
        /// </summary>
        /// <value>テナント情報(Tenant Info)</value>
