...
namespace authapi.Model
{
    ...
    public partial class DnsRecord : IEquatable<DnsRecord>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>CNAMEリソースレコード(CNAME Resource Record)</value>
        ...
        /// Initializes a new instance of the <see cref="DnsRecord" /> class.
        /// </summary>
        /// <param name="type">CNAMEリソースレコード(CNAME Resource Record) (required).</param>
        /// <param name="name">レコード名(Record Name) (required).</param>
        /// <param name="value">値(Value) (required).</param>
