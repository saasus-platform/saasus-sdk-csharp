...
namespace authapi.Model
{
    ...
    public partial class PlanReservation : IEquatable<PlanReservation>, IValidatableObject
    {
        ...
        public PlanReservation(string nextPlanId = default(string), int usingNextPlanFrom = default(int), string nextPlanTaxRateId = default(string), ProrationBehavior? prorationBehavior = default(ProrationBehavior?))
        {
