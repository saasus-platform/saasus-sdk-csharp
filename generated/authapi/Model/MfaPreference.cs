...
namespace authapi.Model
{
    ...
    public partial class MfaPreference : IEquatable<MfaPreference>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>MFAの方法(enabledがtrueの場合は必須)(MFA method (required if enabled is true))</value>
        ...
        /// Initializes a new instance of the <see cref="MfaPreference" /> class.
        /// </summary>
        /// <param name="enabled">MFAを有効にするか否か(enable MFA) (required).</param>
        /// <param name="method">MFAの方法(enabledがtrueの場合は必須)(MFA method (required if enabled is true)).</param>
        ...
        /// </summary>
        /// <value>MFAを有効にするか否か(enable MFA)</value>
