...
namespace authapi.Model
{
    ...
    public partial class MfaConfiguration : IEquatable<MfaConfiguration>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>on: apply when all users log in optional: apply to individual users with MFA factor enabled ※ The parameter is currently optional and fixed. </value>
        ...
        /// Initializes a new instance of the <see cref="MfaConfiguration" /> class.
        /// </summary>
        /// <param name="varMfaConfiguration">on: apply when all users log in optional: apply to individual users with MFA factor enabled ※ The parameter is currently optional and fixed.  (required).</param>
