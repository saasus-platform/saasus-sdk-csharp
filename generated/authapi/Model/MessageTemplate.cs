...
namespace authapi.Model
{
    ...
    public partial class MessageTemplate : IEquatable<MessageTemplate>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="MessageTemplate" /> class.
        /// </summary>
        /// <param name="subject">タイトル(title) (required).</param>
        /// <param name="message">メッセージ(message) (required).</param>
        public MessageTemplate(string subject = default(string), string message = default(string))
        {
            // to ensure "subject" is required (not null)
            if (subject == null)
            {
                throw new ArgumentNullException("subject is a required property for MessageTemplate and cannot be null");
            }
            this.Subject = subject;
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for MessageTemplate and cannot be null");
            }
        ...
        /// タイトル(title)
        /// </summary>
        /// <value>タイトル(title)</value>
        /// <example>Verify your new account</example>
        ...
        /// メッセージ(message)
        /// </summary>
        /// <value>メッセージ(message)</value>
        /// <example>The verification code to your new account is {####}</example>
