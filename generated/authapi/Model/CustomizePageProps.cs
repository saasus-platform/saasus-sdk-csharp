...
namespace authapi.Model
{
    ...
    public partial class CustomizePageProps : IEquatable<CustomizePageProps>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CustomizePageProps" /> class.
        /// </summary>
        /// <param name="htmlContents">Edit page HTML ※ This function is not yet provided, so it cannot be changed or saved.  (required).</param>
        /// <param name="isTermsOfService">display the terms of use agreement check box (required).</param>
        /// <param name="isPrivacyPolicy">show the privacy policy checkbox (required).</param>
        ...
        /// </summary>
        /// <value>Edit page HTML ※ This function is not yet provided, so it cannot be changed or saved. </value>
        ...
        /// </summary>
        /// <value>display the terms of use agreement check box</value>
        ...
        /// </summary>
        /// <value>show the privacy policy checkbox</value>
        /// <example>true</example>
