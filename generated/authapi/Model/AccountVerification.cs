...
namespace authapi.Model
{
    ...
    public partial class AccountVerification : IEquatable<AccountVerification>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>code: verification code link: verification link ※ This function is not yet provided, so it cannot be changed or saved. </value>
        ...
        /// </summary>
        /// <value>email: e-mail sms: SMS smsOrEmail: email if SMS is not possible </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// Initializes a new instance of the <see cref="AccountVerification" /> class.
        /// </summary>
        /// <param name="verificationMethod">code: verification code link: verification link ※ This function is not yet provided, so it cannot be changed or saved.  (required).</param>
        /// <param name="sendingTo">email: e-mail sms: SMS smsOrEmail: email if SMS is not possible  (required).</param>
