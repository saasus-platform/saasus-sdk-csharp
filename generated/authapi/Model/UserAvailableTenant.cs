...
namespace authapi.Model
{
    ...
    public partial class UserAvailableTenant : IEquatable<UserAvailableTenant>, IValidatableObject
    {
        ...
        /// <param name="envs">environmental info, role info (required).</param>
        /// <param name="userAttribute">user additional attributes (required).</param>
        /// <param name="backOfficeStaffEmail">back office contact email (required).</param>
        /// <param name="planId">planId.</param>
        /// <param name="isPaid">tenant payment status ※ Currently, it is returned only when stripe is linked. .</param>
        ...
        /// </summary>
        /// <value>environmental info, role info</value>
        ...
        /// </summary>
        /// <value>back office contact email</value>
        ...
        /// </summary>
        /// <value>tenant payment status ※ Currently, it is returned only when stripe is linked. </value>
        /// <example>true</example>
