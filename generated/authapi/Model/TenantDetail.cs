...
namespace authapi.Model
{
    ...
    public partial class TenantDetail : IEquatable<TenantDetail>, IValidatableObject
    {
        ...
        /// <param name="currentPlanPeriodStart">現在のプランの開始日時(current plan period start).</param>
        /// <param name="currentPlanPeriodEnd">現在のプランの終了日時(current plan period end).</param>
        public TenantDetail(string id = default(string), string planId = default(string), BillingInfo billingInfo = default(BillingInfo), string name = default(string), Dictionary<string, Object> attributes = default(Dictionary<string, Object>), string backOfficeStaffEmail = default(string), string nextPlanId = default(string), int usingNextPlanFrom = default(int), string nextPlanTaxRateId = default(string), ProrationBehavior? prorationBehavior = default(ProrationBehavior?), List<PlanHistory> planHistories = default(List<PlanHistory>), int currentPlanPeriodStart = default(int), int currentPlanPeriodEnd = default(int))
        {
        ...
        /// </summary>
        /// <value>現在のプランの開始日時(current plan period start)</value>
        ...
        /// </summary>
        /// <value>現在のプランの終了日時(current plan period end)</value>
