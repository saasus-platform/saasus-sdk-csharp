...
namespace authapi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCustomizePageSettingsParam")]
    public partial class UpdateCustomizePageSettingsParam : IEquatable<UpdateCustomizePageSettingsParam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCustomizePageSettingsParam" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateCustomizePageSettingsParam() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCustomizePageSettingsParam" /> class.
        /// </summary>
        /// <param name="title">サービス名(service name) (required).</param>
        /// <param name="termsOfServiceUrl">利用規約URL(terms of service URL) (required).</param>
        /// <param name="privacyPolicyUrl">プライバシーポリシーURL(privacy policy URL) (required).</param>
        /// <param name="googleTagManagerContainerId">Google Tag Manager コンテナ ID(Google Tag Manager container ID) (required).</param>
        /// <param name="icon">サービスアイコン(service icon) (required).</param>
        /// <param name="favicon">ファビコン(favicon) (required).</param>
        public UpdateCustomizePageSettingsParam(string title = default(string), string termsOfServiceUrl = default(string), string privacyPolicyUrl = default(string), string googleTagManagerContainerId = default(string), string icon = default(string), string favicon = default(string))
        {
            ...
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for UpdateCustomizePageSettingsParam and cannot be null");
            }
            this.Title = title;
            // to ensure "termsOfServiceUrl" is required (not null)
            if (termsOfServiceUrl == null)
            {
                throw new ArgumentNullException("termsOfServiceUrl is a required property for UpdateCustomizePageSettingsParam and cannot be null");
            }
            this.TermsOfServiceUrl = termsOfServiceUrl;
            // to ensure "privacyPolicyUrl" is required (not null)
            if (privacyPolicyUrl == null)
            {
                throw new ArgumentNullException("privacyPolicyUrl is a required property for UpdateCustomizePageSettingsParam and cannot be null");
            }
            this.PrivacyPolicyUrl = privacyPolicyUrl;
            // to ensure "googleTagManagerContainerId" is required (not null)
            if (googleTagManagerContainerId == null)
            {
                throw new ArgumentNullException("googleTagManagerContainerId is a required property for UpdateCustomizePageSettingsParam and cannot be null");
            }
            this.GoogleTagManagerContainerId = googleTagManagerContainerId;
            // to ensure "icon" is required (not null)
            if (icon == null)
            {
                throw new ArgumentNullException("icon is a required property for UpdateCustomizePageSettingsParam and cannot be null");
            }
            this.Icon = icon;
        ...
        /// サービス名(service name)
        /// </summary>
        /// <value>サービス名(service name)</value>
        ...
        /// </summary>
        /// <value>利用規約URL(terms of service URL)</value>
        ...
        /// </summary>
        /// <value>プライバシーポリシーURL(privacy policy URL)</value>
        ...
        /// </summary>
        /// <value>Google Tag Manager コンテナ ID(Google Tag Manager container ID)</value>
        ...
        /// </summary>
        /// <value>サービスアイコン(service icon)</value>
        /// <example>data:image/png;base64,ZDMiIHN0UmVmOmRvY3VtZW50SUQ9Inhtc&#x3D;&#x3D;</example>
        ...
        {
            return this.Equals(input as UpdateCustomizePageSettingsParam);
        }

        /// <summary>
        /// Returns true if UpdateCustomizePageSettingsParam instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCustomizePageSettingsParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCustomizePageSettingsParam input)
        {
            if (input == null)
            {
                return false;
