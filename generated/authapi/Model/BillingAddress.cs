...
namespace authapi.Model
{
    ...
    public partial class BillingAddress : IEquatable<BillingAddress>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="BillingAddress" /> class.
        /// </summary>
        /// <param name="street">住所の通りの名前や番地を含めた部分  Street address, apartment or suite number.  (required).</param>
        /// <param name="city">住所の市区町村  City, district, suburb, town, or village.  (required).</param>
        /// <param name="state">住所の都道府県または州  State name or abbreviation.  (required).</param>
        /// <param name="country">住所の国を ISO 3166-1 alpha-2 コードで指定します。  Country of the address using ISO 3166-1 alpha-2 code.  (required).</param>
        /// <param name="additionalAddressInfo">建物名・部屋番号などの住所に関する追加情報  Additional information about the address, such as a building name, floor, or department name. .</param>
        /// <param name="postalCode">郵便番号  ZIP or postal code.  (required).</param>
        ...
        /// </summary>
        /// <value>住所の通りの名前や番地を含めた部分  Street address, apartment or suite number. </value>
        ...
        /// </summary>
        /// <value>住所の市区町村  City, district, suburb, town, or village. </value>
        /// <example>渋谷区</example>
        ...
        /// </summary>
        /// <value>住所の都道府県または州  State name or abbreviation. </value>
        /// <example>東京都</example>
        ...
        /// </summary>
        /// <value>住所の国を ISO 3166-1 alpha-2 コードで指定します。  Country of the address using ISO 3166-1 alpha-2 code. </value>
        /// <example>JP</example>
        ...
        /// </summary>
        /// <value>建物名・部屋番号などの住所に関する追加情報  Additional information about the address, such as a building name, floor, or department name. </value>
        ...
        /// </summary>
        /// <value>郵便番号  ZIP or postal code. </value>
