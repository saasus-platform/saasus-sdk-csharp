...
namespace authapi.Model
{
    ...
    public partial class UpdateBasicInfoParam : IEquatable<UpdateBasicInfoParam>, IValidatableObject
    {
        ...
        /// <param name="fromEmailAddress">認証メールの送信元メールアドレス(Sender email of authentication email) (required).</param>
        /// <param name="replyEmailAddress">認証メールの返信元メールアドレス(Reply-from email address of authentication email).</param>
        ...
        /// </summary>
        /// <value>認証メールの送信元メールアドレス(Sender email of authentication email)</value>
