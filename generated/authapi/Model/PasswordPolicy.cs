...
namespace authapi.Model
{
    ...
    public partial class PasswordPolicy : IEquatable<PasswordPolicy>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="PasswordPolicy" /> class.
        /// </summary>
        /// <param name="minimumLength">最小文字数(minimum number of characters) (required).</param>
        /// <param name="isRequireLowercase">一文字以上の小文字を含むが設定されているか(contains one or more lowercase characters) (required).</param>
        /// <param name="isRequireNumbers">一文字以上の数字を含むが設定されているか(contains one or more numeric characters) (required).</param>
        /// <param name="isRequireSymbols">一文字以上の特殊文字を含むが設定されているか(contains one or more special characters) (required).</param>
        /// <param name="isRequireUppercase">一文字以上の大文字を含むが設定されているか(contains one or more uppercase letters) (required).</param>
        /// <param name="temporaryPasswordValidityDays">仮パスワードの有効期限(temporary password expiration date) (required).</param>
        ...
        /// </summary>
        /// <value>最小文字数(minimum number of characters)</value>
        /// <example>10</example>
        ...
        /// </summary>
        /// <value>一文字以上の小文字を含むが設定されているか(contains one or more lowercase characters)</value>
        ...
        /// </summary>
        /// <value>一文字以上の数字を含むが設定されているか(contains one or more numeric characters)</value>
        /// <example>true</example>
        ...
        /// </summary>
        /// <value>一文字以上の特殊文字を含むが設定されているか(contains one or more special characters)</value>
        /// <example>true</example>
        ...
        /// </summary>
        /// <value>一文字以上の大文字を含むが設定されているか(contains one or more uppercase letters)</value>
        /// <example>true</example>
        ...
        /// </summary>
        /// <value>仮パスワードの有効期限(temporary password expiration date)</value>
        /// <example>10</example>
