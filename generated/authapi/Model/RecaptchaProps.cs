...
namespace authapi.Model
{
    ...
    public partial class RecaptchaProps : IEquatable<RecaptchaProps>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="RecaptchaProps" /> class.
        /// </summary>
        /// <param name="siteKey">サイトキー(site key) (required).</param>
        /// <param name="secretKey">シークレットキー(secret key) (required).</param>
        ...
        /// シークレットキー(secret key)
        /// </summary>
        /// <value>シークレットキー(secret key)</value>
