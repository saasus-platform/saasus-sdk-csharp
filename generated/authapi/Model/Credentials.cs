...
namespace authapi.Model
{
    ...
    public partial class Credentials : IEquatable<Credentials>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Credentials" /> class.
        /// </summary>
        /// <param name="idToken">IDトークン(ID token) (required).</param>
        /// <param name="accessToken">アクセストークン(access token) (required).</param>
        /// <param name="refreshToken">リフレッシュトークン(refresh token).</param>
        ...
        /// </summary>
        /// <value>リフレッシュトークン(refresh token)</value>
