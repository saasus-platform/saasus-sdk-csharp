...
namespace authapi.Model
{
    ...
    public partial class Error : IEquatable<Error>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Error" /> class.
        /// </summary>
        /// <param name="type">permission_denied (required).</param>
        /// <param name="message">Error message (required).</param>
        /// <param name="data">data.</param>
        public Error(string type = default(string), string message = default(string), Dictionary<string, Object> data = default(Dictionary<string, Object>))
        {
