...
namespace awsmarketplaceapi.Model
{
    ...
    /// SavePlanParam
    /// </summary>
    [DataContract(Name = "SavePlanParam")]
    public partial class SavePlanParam : IEquatable<SavePlanParam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SavePlanParam" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SavePlanParam() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SavePlanParam" /> class.
        /// </summary>
        /// <param name="planId">planId (required).</param>
        /// <param name="planName">planName (required).</param>
        public SavePlanParam(string planId = default(string), string planName = default(string))
        {
            // to ensure "planId" is required (not null)
            if (planId == null)
            {
                throw new ArgumentNullException("planId is a required property for SavePlanParam and cannot be null");
            }
            this.PlanId = planId;
            // to ensure "planName" is required (not null)
            if (planName == null)
            {
                throw new ArgumentNullException("planName is a required property for SavePlanParam and cannot be null");
            }
        ...
        {
            return this.Equals(input as SavePlanParam);
        }

        /// <summary>
        /// Returns true if SavePlanParam instances are equal
        /// </summary>
        /// <param name="input">Instance of SavePlanParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SavePlanParam input)
        {
            if (input == null)
            {
                return false;
