...
namespace pricingapi.Model
{
    ...
    public partial class TaxRate : IEquatable<TaxRate>, IValidatableObject
    {
        ...
        public TaxRate(string name = default(string), string displayName = default(string), decimal percentage = default(decimal), bool inclusive = default(bool), string country = default(string), string description = default(string), string id = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TaxRate and cannot be null");
            }
            this.Name = name;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for TaxRate and cannot be null");
            }
            ...
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for TaxRate and cannot be null");
            }
            this.Country = country;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for TaxRate and cannot be null");
            }
            this.Description = description;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TaxRate and cannot be null");
            }
            this.Id = id;
        }
