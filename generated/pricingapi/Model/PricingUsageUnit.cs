...
namespace pricingapi.Model
{
    ...
    /// PricingUsageUnit
    /// </summary>
    [DataContract(Name = "PricingUsageUnit")]
    public partial class PricingUsageUnit : IEquatable<PricingUsageUnit>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingUsageUnit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingUsageUnit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingUsageUnit" /> class.
        /// </summary>
        /// <param name="upperCount">Upper limit (required).</param>
        /// <param name="unitAmount">Amount per usage (required).</param>
        ...
        public PricingUsageUnit(int upperCount = default(int), int unitAmount = default(int), string meteringUnitName = default(string), AggregateUsage? aggregateUsage = default(AggregateUsage?), string name = default(string), string displayName = default(string), string description = default(string), UnitType type = default(UnitType), Currency currency = default(Currency), string id = default(string), string meteringUnitId = default(string), RecurringInterval recurringInterval = default(RecurringInterval), bool used = default(bool))
        {
            ...
            {
                throw new ArgumentNullException("meteringUnitName is a required property for PricingUsageUnit and cannot be null");
            }
            this.MeteringUnitName = meteringUnitName;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PricingUsageUnit and cannot be null");
            }
            this.Name = name;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for PricingUsageUnit and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for PricingUsageUnit and cannot be null");
            }
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PricingUsageUnit and cannot be null");
            }
            this.Id = id;
            // to ensure "meteringUnitId" is required (not null)
            if (meteringUnitId == null)
            {
                throw new ArgumentNullException("meteringUnitId is a required property for PricingUsageUnit and cannot be null");
            }
        ...
        {
            return this.Equals(input as PricingUsageUnit);
        }

        /// <summary>
        /// Returns true if PricingUsageUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingUsageUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingUsageUnit input)
        {
            if (input == null)
            {
                return false;
