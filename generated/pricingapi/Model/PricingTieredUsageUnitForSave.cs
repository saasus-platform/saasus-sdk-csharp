...
namespace pricingapi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PricingTieredUsageUnitForSave")]
    public partial class PricingTieredUsageUnitForSave : IEquatable<PricingTieredUsageUnitForSave>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingTieredUsageUnitForSave" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingTieredUsageUnitForSave() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingTieredUsageUnitForSave" /> class.
        /// </summary>
        ...
        public PricingTieredUsageUnitForSave(string name = default(string), string displayName = default(string), string description = default(string), UnitType type = default(UnitType), Currency currency = default(Currency), List<PricingTier> tiers = default(List<PricingTier>), int upperCount = default(int), string meteringUnitName = default(string), AggregateUsage? aggregateUsage = default(AggregateUsage?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PricingTieredUsageUnitForSave and cannot be null");
            }
            this.Name = name;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for PricingTieredUsageUnitForSave and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for PricingTieredUsageUnitForSave and cannot be null");
            }
            ...
            if (tiers == null)
            {
                throw new ArgumentNullException("tiers is a required property for PricingTieredUsageUnitForSave and cannot be null");
            }
            this.Tiers = tiers;
            ...
            {
                throw new ArgumentNullException("meteringUnitName is a required property for PricingTieredUsageUnitForSave and cannot be null");
            }
        ...
        {
            return this.Equals(input as PricingTieredUsageUnitForSave);
        }

        /// <summary>
        /// Returns true if PricingTieredUsageUnitForSave instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingTieredUsageUnitForSave to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingTieredUsageUnitForSave input)
        {
            if (input == null)
            {
                return false;
