...
namespace pricingapi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PricingTieredUsageUnit")]
    public partial class PricingTieredUsageUnit : IEquatable<PricingTieredUsageUnit>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingTieredUsageUnit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingTieredUsageUnit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingTieredUsageUnit" /> class.
        /// </summary>
        ...
        public PricingTieredUsageUnit(int upperCount = default(int), string meteringUnitName = default(string), AggregateUsage? aggregateUsage = default(AggregateUsage?), string name = default(string), string displayName = default(string), string description = default(string), UnitType type = default(UnitType), Currency currency = default(Currency), List<PricingTier> tiers = default(List<PricingTier>), string id = default(string), string meteringUnitId = default(string), RecurringInterval recurringInterval = default(RecurringInterval), bool used = default(bool))
        {
            this.UpperCount = upperCount;
            // to ensure "meteringUnitName" is required (not null)
            if (meteringUnitName == null)
            {
                throw new ArgumentNullException("meteringUnitName is a required property for PricingTieredUsageUnit and cannot be null");
            }
            this.MeteringUnitName = meteringUnitName;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PricingTieredUsageUnit and cannot be null");
            }
            this.Name = name;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for PricingTieredUsageUnit and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for PricingTieredUsageUnit and cannot be null");
            }
            ...
            if (tiers == null)
            {
                throw new ArgumentNullException("tiers is a required property for PricingTieredUsageUnit and cannot be null");
            }
            this.Tiers = tiers;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PricingTieredUsageUnit and cannot be null");
            }
            this.Id = id;
            // to ensure "meteringUnitId" is required (not null)
            if (meteringUnitId == null)
            {
                throw new ArgumentNullException("meteringUnitId is a required property for PricingTieredUsageUnit and cannot be null");
            }
        ...
        {
            return this.Equals(input as PricingTieredUsageUnit);
        }

        /// <summary>
        /// Returns true if PricingTieredUsageUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingTieredUsageUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingTieredUsageUnit input)
        {
            if (input == null)
            {
                return false;
