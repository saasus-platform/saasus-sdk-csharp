...
namespace pricingapi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PricingUsageUnitForSave")]
    public partial class PricingUsageUnitForSave : IEquatable<PricingUsageUnitForSave>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingUsageUnitForSave" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingUsageUnitForSave() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingUsageUnitForSave" /> class.
        /// </summary>
        ...
        public PricingUsageUnitForSave(string name = default(string), string displayName = default(string), string description = default(string), UnitType type = default(UnitType), Currency currency = default(Currency), int upperCount = default(int), int unitAmount = default(int), string meteringUnitName = default(string), AggregateUsage? aggregateUsage = default(AggregateUsage?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PricingUsageUnitForSave and cannot be null");
            }
            this.Name = name;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for PricingUsageUnitForSave and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for PricingUsageUnitForSave and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("meteringUnitName is a required property for PricingUsageUnitForSave and cannot be null");
            }
        ...
        {
            return this.Equals(input as PricingUsageUnitForSave);
        }

        /// <summary>
        /// Returns true if PricingUsageUnitForSave instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingUsageUnitForSave to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingUsageUnitForSave input)
        {
            if (input == null)
            {
                return false;
