...
namespace pricingapi.Model
{
    ...
    /// PricingFixedUnit
    /// </summary>
    [DataContract(Name = "PricingFixedUnit")]
    public partial class PricingFixedUnit : IEquatable<PricingFixedUnit>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingFixedUnit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingFixedUnit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingFixedUnit" /> class.
        /// </summary>
        ...
        public PricingFixedUnit(int unitAmount = default(int), RecurringInterval recurringInterval = default(RecurringInterval), string name = default(string), string displayName = default(string), string description = default(string), UnitType type = default(UnitType), Currency currency = default(Currency), string id = default(string), bool used = default(bool))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PricingFixedUnit and cannot be null");
            }
            this.Name = name;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for PricingFixedUnit and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for PricingFixedUnit and cannot be null");
            }
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PricingFixedUnit and cannot be null");
            }
            this.Id = id;
            this.Used = used;
        }
        ...
        {
            return this.Equals(input as PricingFixedUnit);
        }

        /// <summary>
        /// Returns true if PricingFixedUnit instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingFixedUnit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingFixedUnit input)
        {
            if (input == null)
            {
                return false;
