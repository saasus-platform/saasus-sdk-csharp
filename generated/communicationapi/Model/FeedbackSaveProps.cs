...
namespace communicationapi.Model
{
    ...
    /// FeedbackSaveProps
    /// </summary>
    [DataContract(Name = "FeedbackSaveProps")]
    public partial class FeedbackSaveProps : IEquatable<FeedbackSaveProps>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackSaveProps" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeedbackSaveProps() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackSaveProps" /> class.
        /// </summary>
        /// <param name="feedbackTitle">feedbackTitle (required).</param>
        /// <param name="feedbackDescription">feedbackDescription (required).</param>
        public FeedbackSaveProps(string feedbackTitle = default(string), string feedbackDescription = default(string))
        {
            // to ensure "feedbackTitle" is required (not null)
            if (feedbackTitle == null)
            {
                throw new ArgumentNullException("feedbackTitle is a required property for FeedbackSaveProps and cannot be null");
            }
            this.FeedbackTitle = feedbackTitle;
            // to ensure "feedbackDescription" is required (not null)
            if (feedbackDescription == null)
            {
                throw new ArgumentNullException("feedbackDescription is a required property for FeedbackSaveProps and cannot be null");
            }
        ...
        {
            return this.Equals(input as FeedbackSaveProps);
        }

        /// <summary>
        /// Returns true if FeedbackSaveProps instances are equal
        /// </summary>
        /// <param name="input">Instance of FeedbackSaveProps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeedbackSaveProps input)
        {
            if (input == null)
            {
                return false;
